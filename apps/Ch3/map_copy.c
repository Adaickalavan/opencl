...
#define PROGRAM_FILE "./apps/Ch3/map_copy.cl"
...
int main() {
   ...
   printf("Sizeof cl_mem %ld\n",sizeof(cl_mem));
   size_t buffer_one_size;
   clGetMemObjectInfo(buffer_one, CL_MEM_SIZE,
      sizeof(buffer_one_size), &buffer_one_size, NULL);
   printf("buffer_one size: %lu\n", buffer_one_size);
